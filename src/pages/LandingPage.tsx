                            ...
                            <Card className="mb-8">
                                ...
                                <CardContent>
                                    <p className="text-gray-300 leading-relaxed">
                                        vanadium revolutionizes web development
                                        by combining the power of AI with
                                        blockchain technology. We believe that
                                        creating beautiful, functional React
                                        applications should be as simple as
                            ...
                            <Card className="mb-8">
                                ...
                                <CardContent>
                                    <p className="text-gray-300 leading-relaxed mb-4">
                                        Built on cutting-edge technologies to
                                        ensure security, performance, and
                                        scalability:
                                    </p>
                                    <ul className="text-gray-300 space-y-2">
                                        <li>
                                            • <strong>Frontend:</strong> Vite +
                                            React + TypeScript + Tailwind CSS
                                        </li>
                                        <li>
                                            • <strong>Backend:</strong> Internet
                                            Computer Protocol (ICP) + Motoko
                                        </li>
                                        <li>
                                            • <strong>AI Engine:</strong>{" "}
                                            Advanced language models optimized
                                            for code generation
                                        </li>
                                        <li>
                            ...
                            <div className="mb-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <Button asChild size="lg" className="group">
                                        <a className="" onClick={navigateToZ9}>
                                            Start Building
