...
import CanvasPane, { CanvasPaneHandle } from "@/components/CanvasPane";
...
const Z9Page: React.FC = () => {
    ...
    const handleDownloadProject = async () => {
        ...
        const addFilesToZip = (nodes: FileNode[], currentPath: string) => {
            for (const node of nodes) {
                ...
                if (node.type === "folder") {
                    ...
                    // Add file to zip. Use an empty string if content is undefined.
        ...
        try {
            ...
            saveAs(content, `project-${currentChat || "new"}.zip`);
        } catch (error) {
...
`,
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            let canvasData = null;
            let canvasDescription = ""; // We'll get this from the capture too
            ...
            if (
                ...
                // Await the result directly from the capture function
                const captureResult =
                    await canvasPaneRef.current.captureCanvas();

                if (captureResult) {
                    canvasData = captureResult.dataUrl;
                    canvasDescription = captureResult.description;
                }

                console.log(
                    "Captured Canvas Data directly:",
                    canvasData,
                    canvasDescription
                );
            }
            ...
            const aiResponse = await aiService.sendMessage(
                input,
                canvasData, // Pass the captured canvas data with preview
                fileTree
            );
                        ...
                        <div className="flex items-center justify-between p-3 border-b border-gray-800">
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    // You might want a download icon here
